  ...
  return (
    <div>
      ...
      <div className="mt-10 px-14">
        ...
        style={{ color: '#1B4E9B' }}>Пользователи</h3>
      </div>
      <div className="flex mt-[20px] mb-[20px] justify-between items-end">
        <input className="w-[362px] h-[40px] px-[17.14px] ml-[58px] bg-white border-1 border-[#1B4E9B] rounded-full  text-[#1B4E9B] placeholder:text-[#D9D9D9] text-[12px] font-montserrat-semibold"
